...
package malaria.com.malaria.tensorflow;
...
public class ImageUtils {
  ...
  static {
    try {
      ...
      System.out.print("Native library not found, native RGB -> YUV conversion may be unavailable.");
    }
  }
  ...
  public static void saveBitmap(final Bitmap bitmap, final String filename) {
    ...
    System.out.print(String.format("Saving %dx%d bitmap to %s.", bitmap.getWidth(), bitmap.getHeight(), root));
    final File myDir = new File(root);

    if (!myDir.mkdirs()) {
      System.out.print("Make dir failed");
    }
  ...
  public static Matrix getTransformationMatrix(
    ...
    if (applyRotation != 0) {
      if (applyRotation % 90 != 0) {
        System.out.print(String.format("Rotation of %d % 90 != 0", applyRotation));
      }
